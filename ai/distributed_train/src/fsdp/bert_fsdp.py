...
def train(device, model, train_loader=None, test_loader=None, train_sampler=None, epochs=15, lr=2e-5, rank=None):
    ...
    # 使用FSDP将model warp起来
    model = FSDP(model, auto_wrap_policy=transformer_auto_wrap_policy, cpu_offload=CPUOffload(offload_params=True))
